...
public class WeeklyItemAdapter extends RecyclerView.Adapter<WeeklyItemAdapter.ViewHolder> {
    ...
    public WeeklyItemAdapter(List<String> zodiacSign, List<Integer> zodiacImg, List<String> date, List<String> zodiacCall, Context context) {
    ...
    @NonNull
    @Override
    public WeeklyItemAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull WeeklyItemAdapter.ViewHolder holder, int position) {
